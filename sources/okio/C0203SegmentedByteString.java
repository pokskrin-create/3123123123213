...
public final class C0203SegmentedByteString extends ByteString {
    ...
    public C0203SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        C0203SegmentedByteString c0203SegmentedByteString = this;
        int iResolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0203SegmentedByteString, endIndex);
        if (beginIndex < 0) {
        ...
        if (beginIndex == 0 && iResolveDefaultParameter == size()) {
            return c0203SegmentedByteString;
        }
