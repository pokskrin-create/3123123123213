...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM479constructorimpl2;
        ...
        try {
            ...
            objM479constructorimpl = Result.m479constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM479constructorimpl = Result.m479constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m482exceptionOrNullimpl(objM479constructorimpl) == null) {
            obj2 = objM479constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM479constructorimpl2 = Result.m479constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM479constructorimpl2 = Result.m479constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m482exceptionOrNullimpl(objM479constructorimpl2) == null) {
            obj = objM479constructorimpl2;
        }
