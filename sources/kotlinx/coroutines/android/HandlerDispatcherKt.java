...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM479constructorimpl = Result.m479constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM479constructorimpl = Result.m479constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m485isFailureimpl(objM479constructorimpl) ? null : objM479constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2094dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
