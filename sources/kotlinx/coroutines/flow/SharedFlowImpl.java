    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation<Unit> continuation : continuationArrFindSlotsToResumeLocked) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m479constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
        ...
        synchronized (this) {
            try {
                if (tryEmitLocked(t)) {
                    try {
                        Result.Companion companion = Result.INSTANCE;
                        cancellableContinuationImpl2.resumeWith(Result.m479constructorimpl(Unit.INSTANCE));
                ...
                for (Continuation<Unit> continuation2 : continuationArrFindSlotsToResumeLocked) {
                    if (continuation2 != null) {
                        ...
                        continuation2.resumeWith(Result.m479constructorimpl(Unit.INSTANCE));
                    }
                }
