...
public interface SendChannel<E> {
    ...
    Object mo2028trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2053isSuccessimpl(objMo2028trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2047exceptionOrNullimpl = ChannelResult.m2047exceptionOrNullimpl(objMo2028trySendJP2dKIU);
