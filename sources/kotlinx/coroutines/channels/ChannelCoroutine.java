...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2035receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2035receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2036tryReceivePtdJZtk() {
        return this._channel.mo2036tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2028trySendJP2dKIU(E e) {
        return this._channel.mo2028trySendJP2dKIU(e);
    }
