...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                objM479constructorimpl = Result.m479constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM479constructorimpl = Result.m479constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2043boximpl(Result.m486isSuccessimpl(objM479constructorimpl) ? ChannelResult.INSTANCE.m2058successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2056closedJP2dKIU(Result.m482exceptionOrNullimpl(objM479constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2028trySendJP2dKIU = sendChannel.mo2028trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2053isSuccessimpl(sendChannel.mo2028trySendJP2dKIU(obj))) {
            return;
        }
