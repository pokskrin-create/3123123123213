...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2062trySendImplMj0NB7M = conflatedBufferedChannel.m2062trySendImplMj0NB7M(e, true);
        if (objM2062trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2047exceptionOrNullimpl(objM2062trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2062trySendImplMj0NB7M = conflatedBufferedChannel.m2062trySendImplMj0NB7M(e, true);
        if (!(objM2062trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2028trySendJP2dKIU(E element) {
        return m2062trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2062trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2061trySendDropLatestMj0NB7M(element, isSendOp) : m2037trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2061trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2028trySendJP2dKIU = super.mo2028trySendJP2dKIU(element);
        if (ChannelResult.m2053isSuccessimpl(objMo2028trySendJP2dKIU) || ChannelResult.m2051isClosedimpl(objMo2028trySendJP2dKIU)) {
            return objMo2028trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2028trySendJP2dKIU = mo2028trySendJP2dKIU(element);
        if (!(objMo2028trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2028trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2047exceptionOrNullimpl(objMo2028trySendJP2dKIU);
