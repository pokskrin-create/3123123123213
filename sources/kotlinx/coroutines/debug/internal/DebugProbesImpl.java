...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            objM479constructorimpl = Result.m479constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM479constructorimpl = Result.m479constructorimpl(ResultKt.createFailure(th));
        }
        return (Function1) (Result.m485isFailureimpl(objM479constructorimpl) ? null : objM479constructorimpl);
    }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        if (Intrinsics.areEqual(state, DebugCoroutineInfoImplKt.RUNNING) && thread != null) {
            try {
                Result.Companion companion = Result.INSTANCE;
                DebugProbesImpl debugProbesImpl = this;
                objM479constructorimpl = Result.m479constructorimpl(thread.getStackTrace());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM479constructorimpl = Result.m479constructorimpl(ResultKt.createFailure(th));
            }
            ...
            StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM479constructorimpl;
