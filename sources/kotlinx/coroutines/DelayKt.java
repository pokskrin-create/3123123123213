...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2095scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2016delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2017toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2017toDelayMillisLRDsOJo(long j) {
        boolean zM1900isPositiveimpl = Duration.m1900isPositiveimpl(j);
        if (zM1900isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m1884getInWholeMillisecondsimpl(Duration.m1902plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM1900isPositiveimpl) {
