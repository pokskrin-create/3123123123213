    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i9 = 0; i9 < i5; i9++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i6) {
                ...
                if (this.mOrientation == 1) {
                    childMeasureSpec2 = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i11, layoutParams.width, false);
                    childMeasureSpec = View.MeasureSpec.makeMeasureSpec(i6 - i10, Ints.MAX_POWER_OF_TWO);
                } else {
                    int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i6 - i11, Ints.MAX_POWER_OF_TWO);
                    childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i10, layoutParams.height, false);
