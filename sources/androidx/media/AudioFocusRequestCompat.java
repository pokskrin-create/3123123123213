...
public class AudioFocusRequestCompat {
    ...
    AudioFocusRequestCompat(int i, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler, AudioAttributesCompat audioAttributesCompat, boolean z) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            AudioManagerCompat$$ExternalSyntheticApiModelOutline0.m202m();
            this.mFrameworkAudioFocusRequest = AudioManagerCompat$$ExternalSyntheticApiModelOutline0.m(i).setAudioAttributes(getAudioAttributes()).setWillPauseWhenDucked(z).setOnAudioFocusChangeListener(this.mOnAudioFocusChangeListener, handler).build();
        } else {
    ...
    AudioFocusRequest getAudioFocusRequest() {
        return AudioManagerCompat$$ExternalSyntheticApiModelOutline0.m194m(this.mFrameworkAudioFocusRequest);
    }
