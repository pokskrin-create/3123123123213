...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = WindowCompat$$ExternalSyntheticApiModelOutline0.m133m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM133m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM133m = WindowCompat$$ExternalSyntheticApiModelOutline0.m134m(windowInsets);
            } else {
                builderM133m = WindowCompat$$ExternalSyntheticApiModelOutline0.m133m();
            }
            this.mPlatBuilder = builderM133m;
        }
