...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 36 && str.equals(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1().getName())) {
    ...
    public static class ProgressStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 36) {
                ...
                Notification.ProgressStyle progressStyleM6m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m6m();
                Api36Impl.setStyledByProgress(progressStyleM6m, this.mIsStyledByProgress);
                Api36Impl.setProgress(progressStyleM6m, this.mProgress);
                Api36Impl.setProgressIndeterminate(progressStyleM6m, this.mIndeterminate);
                IconCompat iconCompat = this.mStartIcon;
                Api36Impl.setProgressStartIcon(progressStyleM6m, iconCompat != null ? iconCompat.toIcon(context) : null);
                IconCompat iconCompat2 = this.mEndIcon;
                Api36Impl.setProgressEndIcon(progressStyleM6m, iconCompat2 != null ? iconCompat2.toIcon(context) : null);
                IconCompat iconCompat3 = this.mTrackerIcon;
                Api36Impl.setProgressTrackerIcon(progressStyleM6m, iconCompat3 != null ? iconCompat3.toIcon(context) : null);
                Api36Impl.setProgressPoints(progressStyleM6m, this.mProgressPoints);
                Api36Impl.setProgressSegments(progressStyleM6m, this.mProgressSegments);
                builder.setStyle(progressStyleM6m);
                return;
            }
