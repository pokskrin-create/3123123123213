    ...
    private static final class Ext10Impl {
        ...
        public static final class Companion {
            ...
            public final android.adservices.adselection.ReportEventRequest convertReportEventRequest(ReportEventRequest request) {
                ...
                AudioManagerCompat$$ExternalSyntheticApiModelOutline0.m207m$1();
                android.adservices.adselection.ReportEventRequest reportEventRequestBuild = AudioManagerCompat$$ExternalSyntheticApiModelOutline0.m(request.getAdSelectionId(), request.getEventKey(), request.getEventData(), request.getReportingDestinations()).setInputEvent(request.getInputEvent()).build();
    ...
    private static final class Ext8Impl {
        ...
        public static final class Companion {
            ...
            public final android.adservices.adselection.ReportEventRequest convertReportEventRequest(ReportEventRequest request) {
                ...
                AudioManagerCompat$$ExternalSyntheticApiModelOutline0.m207m$1();
                android.adservices.adselection.ReportEventRequest reportEventRequestBuild = AudioManagerCompat$$ExternalSyntheticApiModelOutline0.m(request.getAdSelectionId(), request.getEventKey(), request.getEventData(), request.getReportingDestinations()).build();
                Intrinsics.checkNotNullExpressionValue(reportEventRequestBuild, "Builder(\n               …                 .build()");
                return reportEventRequestBuild;
            }
        }
