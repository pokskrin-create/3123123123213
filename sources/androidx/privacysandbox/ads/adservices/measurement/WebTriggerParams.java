    ...
    public static final class Companion {
        ...
        public final List<android.adservices.measurement.WebTriggerParams> convertWebTriggerParams$ads_adservices_release(List<WebTriggerParams> request) {
            ...
            for (WebTriggerParams webTriggerParams : request) {
                AdFilters$$ExternalSyntheticApiModelOutline0.m$5();
                android.adservices.measurement.WebTriggerParams webTriggerParamsBuild = AdFilters$$ExternalSyntheticApiModelOutline0.m224m(webTriggerParams.getRegistrationUri()).setDebugKeyAllowed(webTriggerParams.getDebugKeyAllowed()).build();
