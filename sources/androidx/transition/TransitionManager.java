...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo274clone = transition.mo274clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo274clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo274clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo274clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo274clone = transition.mo274clone();
        sceneChangeSetup(viewGroup, transitionMo274clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo274clone);
    }
