            ...
            if (i == 0) {
                ...
                final Consumer<List<SplitInfo>> consumer = new Consumer() { // from class: androidx.window.embedding.SplitController$splitInfoList$1$$ExternalSyntheticLambda0
                    ...
                    public final void accept(Object obj2) {
                        producerScope.mo2028trySendJP2dKIU((List) obj2);
                    }
                };
                SplitController.this.embeddingBackend.addSplitListenerForActivity(this.$activity, new AdIdManagerImplCommon$$ExternalSyntheticLambda4(), consumer);
