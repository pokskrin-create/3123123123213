...
public abstract class CustomTabsService extends Service {
    ...
    class AnonymousClass1 extends ICustomTabsService.Stub {
            ...
            try {
                IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: androidx.browser.customtabs.CustomTabsService$1$$ExternalSyntheticLambda2
                    ...
                    public final void binderDied() {
                        this.f$0.m35x67c68af6(customTabsSessionToken);
                    }
                };
        ...
        /* synthetic */ void m35x67c68af6(CustomTabsSessionToken customTabsSessionToken) {
        ...
        public void prefetch(ICustomTabsCallback iCustomTabsCallback, Uri uri, Bundle bundle) {
            CustomTabsService.this.prefetch(new CustomTabsSessionToken(iCustomTabsCallback, getSessionIdFromBundle(bundle)), UByte$$ExternalSyntheticBackport0.m(new Object[]{uri}), PrefetchOptions.fromBundle(bundle));
        }
        ...
        public boolean newAuthTabSession(IAuthTabCallback iAuthTabCallback, Bundle bundle) {
            ...
            try {
                IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: androidx.browser.customtabs.CustomTabsService$1$$ExternalSyntheticLambda3
                    @Override // android.os.IBinder.DeathRecipient
                    public final void binderDied() {
                        this.f$0.m34x3d26a773(authTabSessionToken);
                    }
                };
                synchronized (CustomTabsService.this.mDeathRecipientMap) {
        ...
        /* renamed from: lambda$newAuthTabSession$1$androidx-browser-customtabs-CustomTabsService$1, reason: not valid java name */
        /* synthetic */ void m34x3d26a773(AuthTabSessionToken authTabSessionToken) {
