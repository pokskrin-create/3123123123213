...
public class SlidingPaneLayout extends ViewGroup implements Openable {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, Ints.MAX_POWER_OF_TWO);
                }
            ...
            while (i9 < childCount) {
                ...
                if (childAt2.getVisibility() != i3) {
                    ...
                    if (z) {
                        ...
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, Ints.MAX_POWER_OF_TWO);
        ...
        if (arrayListSplitViewPositions != null && !z) {
            for (int i10 = 0; i10 < childCount; i10++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    int iMakeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(childAt3.getMeasuredHeight(), Ints.MAX_POWER_OF_TWO);
                    ...
                    if ((childAt3.getMeasuredWidthAndState() & 16777216) == 1 || (getMinimumWidth(childAt3) != 0 && rect.width() < getMinimumWidth(childAt3))) {
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(i8 - i11, Ints.MAX_POWER_OF_TWO), iMakeMeasureSpec3);
                        if (i10 != 0) {
                        ...
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(rect.width(), Ints.MAX_POWER_OF_TWO), iMakeMeasureSpec3);
                    }
                }
            }
        }
    ...
    private static int measureChildHeight(View view, int i, int i2) {
        ...
        return View.MeasureSpec.makeMeasureSpec(view.getMeasuredHeight(), Ints.MAX_POWER_OF_TWO);
    }
