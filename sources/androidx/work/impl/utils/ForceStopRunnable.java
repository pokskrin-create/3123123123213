            ...
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    ...
                    for (int i = 0; i < historicalProcessExitReasons.size(); i++) {
                        ApplicationExitInfo applicationExitInfoM250m = CanvasUtils$$ExternalSyntheticApiModelOutline0.m250m(historicalProcessExitReasons.get(i));
                        if (applicationExitInfoM250m.getReason() == 10 && applicationExitInfoM250m.getTimestamp() >= lastForceStopEventMillis) {
                            return true;
                        }
                    }
                }
