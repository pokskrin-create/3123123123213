...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C00741 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00741(Set<String> set, Continuation<? super C00741> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00741 c00741 = new C00741(this.$keysToMigrate, continuation);
            c00741.L$0 = obj;
            return c00741;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C00741) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
