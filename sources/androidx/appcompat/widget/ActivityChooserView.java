...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            context2 = context;
            activityChooserView.saveAttributeDataForStyleable(context2, R.styleable.ActivityChooserView, attributeSet, typedArrayObtainStyledAttributes, i, 0);
        } else {
            activityChooserView = this;
            context2 = context;
        }
        activityChooserView.mInitialActivityCount = typedArrayObtainStyledAttributes.getInt(R.styleable.ActivityChooserView_initialActivityCount, 4);
        ...
        activityChooserView.mCallbacks = callbacks;
        View viewFindViewById = findViewById(R.id.activity_chooser_view_content);
        activityChooserView.mActivityChooserContent = viewFindViewById;
        activityChooserView.mActivityChooserContentBackground = viewFindViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(R.id.default_activity_button);
        activityChooserView.mDefaultActivityButton = frameLayout;
        frameLayout.setOnClickListener(callbacks);
        frameLayout.setOnLongClickListener(callbacks);
        activityChooserView.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(R.id.image);
        ...
        activityChooserView.mExpandActivityOverflowButton = frameLayout2;
        ImageView imageView = (ImageView) frameLayout2.findViewById(R.id.image);
        activityChooserView.mExpandActivityOverflowButtonImage = imageView;
        imageView.setImageDrawable(drawable);
        ActivityChooserViewAdapter activityChooserViewAdapter = new ActivityChooserViewAdapter();
        activityChooserView.mAdapter = activityChooserViewAdapter;
        ...
        activityChooserView.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(R.dimen.abc_config_prefDialogWidth));
    }
