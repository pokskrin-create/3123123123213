    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        if (i8 <= 0 || j2 == 0 || (i8 >= i12 - 1 && !z9 && iMax2 <= 1)) {
            ...
            if (z9) {
                ...
                if ((j2 & (1 << i24)) != 0 && !((LayoutParams) getChildAt(i24).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
        ...
        if (z6) {
            for (int i27 = i3; i27 < childCount; i27++) {
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i17) + layoutParams5.extraPixels, Ints.MAX_POWER_OF_TWO), childMeasureSpec);
                }
            }
        }
