...
class AppCompatCompoundButtonHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            } else if (typedArrayObtainStyledAttributes.hasValue(R.styleable.CompoundButton_android_button) && (resourceId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.CompoundButton_android_button, 0)) != 0) {
