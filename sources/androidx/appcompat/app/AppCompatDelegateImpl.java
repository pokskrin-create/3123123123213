...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static {
        sAlwaysOverrideConfiguration = Build.VERSION.SDK_INT <= 25;
    }
    ...
    */
    ...
    private boolean updateForNightMode(int i, boolean z) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        ...
        boolean z3 = false;
        if ((sAlwaysOverrideConfiguration || i3 != i2) && !zIsActivityManifestHandlingUiMode && !this.mBaseContextAttached && (this.mHost instanceof android.view.ContextThemeWrapper)) {
        ...
        if (!z3 && i4 != i3 && z && !zIsActivityManifestHandlingUiMode && this.mBaseContextAttached) {
            Object obj = this.mHost;
            if (obj instanceof Activity) {
