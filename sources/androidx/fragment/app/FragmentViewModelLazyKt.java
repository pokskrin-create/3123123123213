...
public final class FragmentViewModelLazyKt {
    public static /* synthetic */ Lazy viewModels$default(final Fragment fragment, Function0 ownerProducer, Function0 function0, int i, Object obj) {
        ...
        C00782 c00782 = new C00782(lazy);
        C00793 c00793 = new C00793(lazy);
        if (function0 == null) {
            function0 = new C00804(fragment, lazy);
        }
        return createViewModelLazy(fragment, orCreateKotlinClass, c00782, c00793, function0);
    }
    ...
    public static final ViewModelStoreOwner m177viewModels$lambda0(Lazy<? extends ViewModelStoreOwner> lazy) {
    ...
    public static final class C00782 extends Lambda implements Function0<ViewModelStore> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C00782(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
        ...
        public final ViewModelStore invoke() {
            return FragmentViewModelLazyKt.m177viewModels$lambda0(this.$owner$delegate).getViewModelStore();
        }
    }
    ...
    public static final class C00793 extends Lambda implements Function0<CreationExtras> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C00793(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
            this.$owner$delegate = lazy;
        }
        ...
        public final CreationExtras invoke() {
            ...
            ViewModelStoreOwner viewModelStoreOwnerM177viewModels$lambda0 = FragmentViewModelLazyKt.m177viewModels$lambda0(this.$owner$delegate);
            HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = viewModelStoreOwnerM177viewModels$lambda0 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) viewModelStoreOwnerM177viewModels$lambda0 : null;
    ...
    public static final class C00804 extends Lambda implements Function0<ViewModelProvider.Factory> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;
        final /* synthetic */ Fragment $this_viewModels;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C00804(Fragment fragment, Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
    ...
    public static /* synthetic */ Lazy viewModels$default(final Fragment fragment, Function0 ownerProducer, Function0 function0, Function0 function02, int i, Object obj) {
        ...
        Intrinsics.reifiedOperationMarker(4, "VM");
        KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(ViewModel.class);
        C00826 c00826 = new C00826(lazy);
        AnonymousClass7 anonymousClass7 = new AnonymousClass7(function0, lazy);
        if (function02 == null) {
            function02 = new AnonymousClass8(fragment, lazy);
        }
        return createViewModelLazy(fragment, orCreateKotlinClass, c00826, anonymousClass7, function02);
    }
    ...
    public static final ViewModelStoreOwner m178viewModels$lambda1(Lazy<? extends ViewModelStoreOwner> lazy) {
        return lazy.getValue();
    }
    ...
    public static final class C00826 extends Lambda implements Function0<ViewModelStore> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C00826(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
            this.$owner$delegate = lazy;
        }
        ...
        @Override // kotlin.jvm.functions.Function0
        public final ViewModelStore invoke() {
            return FragmentViewModelLazyKt.m178viewModels$lambda1(this.$owner$delegate).getViewModelStore();
        }
    }
    ...
    public static final class AnonymousClass7 extends Lambda implements Function0<CreationExtras> {
        ...
        public final CreationExtras invoke() {
            ...
            ViewModelStoreOwner viewModelStoreOwnerM178viewModels$lambda1 = FragmentViewModelLazyKt.m178viewModels$lambda1(this.$owner$delegate);
            HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = viewModelStoreOwnerM178viewModels$lambda1 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) viewModelStoreOwnerM178viewModels$lambda1 : null;
