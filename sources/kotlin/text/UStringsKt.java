...
public final class UStringsKt {
    ...
    public static final String m1860toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1862toStringolVBNx4(short s, int i) {
    ...
    public static final String m1861toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & KeyboardMap.kValueMask, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m1859toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m578constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m491boximpl(UByte.m497constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m578constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m758boximpl(UShort.m764constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM578constructorimpl = UInt.m578constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM578constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM578constructorimpl2 = UInt.m578constructorimpl(i3 * iM578constructorimpl);
            int iM578constructorimpl3 = UInt.m578constructorimpl(UInt.m578constructorimpl(iDigitOf) + iM578constructorimpl2);
            if (Integer.compare(iM578constructorimpl3 ^ Integer.MIN_VALUE, iM578constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM578constructorimpl3;
        }
        return UInt.m572boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM657constructorimpl = ULong.m657constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM657constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM657constructorimpl2 = ULong.m657constructorimpl(j * jM657constructorimpl);
            long jM657constructorimpl3 = ULong.m657constructorimpl(ULong.m657constructorimpl(UInt.m578constructorimpl(r13) & KeyboardMap.kValueMask) + jM657constructorimpl2);
            if (Long.compare(jM657constructorimpl3 ^ Long.MIN_VALUE, jM657constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM657constructorimpl3;
        }
        return ULong.m651boximpl(j);
    }
}
