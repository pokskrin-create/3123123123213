...
public final class Predicates {
    ...
    private static class ContainsPatternPredicate implements Predicate<CharSequence>, Serializable {
        ...
        public String toString() {
            String string = MoreObjects.toStringHelper(this.pattern).add(MimeTypesReaderMetKeys.PATTERN_ATTR, this.pattern.pattern()).add("pattern.flags", this.pattern.flags()).toString();
