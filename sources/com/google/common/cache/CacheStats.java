...
public final class CacheStats {
    ...
    public double loadExceptionRate() {
        ...
        return jSaturatedAdd == 0 ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE : this.loadExceptionCount / jSaturatedAdd;
    }
    ...
    public double averageLoadPenalty() {
        long jSaturatedAdd = LongMath.saturatedAdd(this.loadSuccessCount, this.loadExceptionCount);
        return jSaturatedAdd == 0 ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE : this.totalLoadTime / jSaturatedAdd;
    }
