...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor MAP_KEY_DESC = FieldDescriptor.builder(ExternalParsersConfigReaderMetKeys.METADATA_KEY_ATTR).withProperty(AtProtobuf.builder().tag(1).build()).build();
