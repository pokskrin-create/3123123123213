...
public class FcmBroadcastProcessor {
    ...
    public FcmBroadcastProcessor(Context context) {
        ...
        this.executor = new AdIdManagerImplCommon$$ExternalSyntheticLambda4();
    }
    ...
    static /* synthetic */ Task lambda$startMessagingService$2(Context context, Intent intent, boolean z, Task task) throws Exception {
        return (PlatformVersion.isAtLeastO() && ((Integer) task.getResult()).intValue() == 402) ? bindToMessagingService(context, intent, z).continueWith(new AdIdManagerImplCommon$$ExternalSyntheticLambda4(), new Continuation() { // from class: com.google.firebase.messaging.FcmBroadcastProcessor$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.tasks.Continuation
    ...
    private static Task<Integer> bindToMessagingService(Context context, Intent intent, boolean z) {
        ...
        return serviceConnection.sendIntent(intent).continueWith(new AdIdManagerImplCommon$$ExternalSyntheticLambda4(), new Continuation() { // from class: com.google.firebase.messaging.FcmBroadcastProcessor$$ExternalSyntheticLambda3
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
