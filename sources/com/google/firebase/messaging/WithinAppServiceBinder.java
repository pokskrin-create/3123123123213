...
class WithinAppServiceBinder extends Binder {
    ...
    void send(final WithinAppServiceConnection.BindRequest bindRequest) {
        ...
        this.intentHandler.handle(bindRequest.intent).addOnCompleteListener(new AdIdManagerImplCommon$$ExternalSyntheticLambda4(), new OnCompleteListener() { // from class: com.google.firebase.messaging.WithinAppServiceBinder$$ExternalSyntheticLambda0
