...
public class AccessibilityBridge extends AccessibilityNodeProvider {
    ...
    public AccessibilityBridge(View view, AccessibilityChannel accessibilityChannel, final AccessibilityManager accessibilityManager, ContentResolver contentResolver, AccessibilityViewEmbedder accessibilityViewEmbedder, PlatformViewsAccessibilityDelegate platformViewsAccessibilityDelegate) {
        ...
        ContentObserver contentObserver = new ContentObserver(new Handler()) { // from class: io.flutter.view.AccessibilityBridge.3
            ...
            public void onChange(boolean z, Uri uri) {
                ...
                if (Settings.Global.getFloat(AccessibilityBridge.this.contentResolver, "transition_animation_scale", AccessibilityBridge.DEFAULT_TRANSITION_ANIMATION_SCALE) == 0.0f) {
    ...
    private boolean shouldSetCollectionInfo(final SemanticsNode semanticsNode) {
        if (semanticsNode.scrollChildren > 0) {
            return SemanticsNode.nullableHasAncestor(this.accessibilityFocusedSemanticsNode, new Predicate() { // from class: io.flutter.view.AccessibilityBridge$$ExternalSyntheticLambda2
            ...
            }) || !SemanticsNode.nullableHasAncestor(this.accessibilityFocusedSemanticsNode, new Predicate() { // from class: io.flutter.view.AccessibilityBridge$$ExternalSyntheticLambda3
                @Override // io.flutter.util.Predicate
                public final boolean test(Object obj) {
    ...
    public boolean onAccessibilityHoverEvent(MotionEvent motionEvent, boolean z) {
        ...
        SemanticsNode semanticsNodeHitTest = getRootSemanticsNode().hitTest(new float[]{motionEvent.getX(), motionEvent.getY(), 0.0f, DEFAULT_TRANSITION_ANIMATION_SCALE}, z);
    ...
    private void handleTouchExploration(float f, float f2, boolean z) {
        ...
        if (this.flutterSemanticsTree.isEmpty() || (semanticsNodeHitTest = getRootSemanticsNode().hitTest(new float[]{f, f2, 0.0f, DEFAULT_TRANSITION_ANIMATION_SCALE}, z)) == this.hoveredObject) {
            return;
        }
    ...
    enum Flag {
        ...
        IS_REQUIRED(Ints.MAX_POWER_OF_TWO);
    ...
    static class SemanticsNode {
        ...
        public void updateRecursively(float[] fArr, Set<SemanticsNode> set, boolean z) {
            ...
            if (z) {
                ...
                float[] fArr2 = {this.left, this.top, 0.0f, AccessibilityBridge.DEFAULT_TRANSITION_ANIMATION_SCALE};
