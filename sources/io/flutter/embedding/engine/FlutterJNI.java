...
public class FlutterJNI {
    ...
    public void loadLibrary(Context context) {
        ...
        ReLinker.log(new ReLinker.Logger() { // from class: io.flutter.embedding.engine.FlutterJNI$$ExternalSyntheticLambda4
    ...
    public static Bitmap decodeImage(ByteBuffer byteBuffer, final long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            try {
                return ImageDecoder.decodeBitmap(ImageDecoder.createSource(byteBuffer), new ImageDecoder$OnHeaderDecodedListener() { // from class: io.flutter.embedding.engine.FlutterJNI$$ExternalSyntheticLambda5
    ...
    static /* synthetic */ void lambda$decodeImage$1(long j, ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source) {
