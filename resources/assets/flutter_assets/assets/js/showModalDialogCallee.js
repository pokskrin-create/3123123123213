...
//popped up page
//----------------------
// Uncaught TypeError: undefined is not a function 발생 아래와 같이 수정
var getDialogArguments = function(obj) {		//function getDialogArguments() {
...
//Uncaught TypeError: undefined is not a function 발생 아래와 같이 수정
var setReturnValue = function(obj) {  	//function setReturnValue(){
	if (!window.showModalDialog) {
		if (opener != null && !opener.closed) {
